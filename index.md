...
venue: "Grandma's house"        # brief name of host site without address (e.g., "Euphoric State University")
address: "123 Gingerbread Lane"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "Feb 1-5, 2022"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "5am-10pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2022-02-01      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2022-02-05        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Teddy Ruxpin"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Barney the Purple Dinosaur"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2019-07-18-sydney            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
